                            ...
                            monaco.languages.registerCompletionItemProvider('html', {
                              ...
                              provideCompletionItems: (_model: any, position: any, _ctx?: any, _token?: any) => {
                                ...
                                const snips = [
                                  ...
                                  { l: 'table', e: '<table>\n\t<thead>\n\t\t<tr>\n\t\t\t<th>${1:Encabezado}</th>\n\t\t</tr>\n\t</thead>\n\t<tbody>\n\t\t<tr>\n\t\t\t<td>${2:Dato}</td>\n\t\t</tr>\n\t</tbody>\n</table>', d: 'Tabla HTML completa' },
                                  { l: 'form', e: '<form action="${1:#}" method="${2|post,get|}">\n\t$0\n</form>', d: 'Formulario' },
                                  { l: 'inp', e: '<input type="${1|text,email,password,number,checkbox,radio,file,hidden|}" name="${2}" placeholder="${3}">', d: 'Input (alias)' },
                                  { l: 'input', e: '<input type="${1|text,email,password,number,checkbox,radio,file,hidden|}" name="${2}" placeholder="${3}">', d: 'Input' },
                                  { l: 'btn', e: '<button type="${1|button,submit,reset|}">${2:Click}</button>', d: 'Botón (alias)' },
                                  { l: 'button', e: '<button type="${1|button,submit,reset|}">${2:Click}</button>', d: 'Botón' },
