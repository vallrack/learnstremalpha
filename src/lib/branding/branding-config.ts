...
export const DEFAULT_BRANDING: BrandingConfig = {
  ...
  logoUrl: process.env.NEXT_PUBLIC_APP_LOGO || '/images/logo-learnstream.png',
...
export const TENANTS_MAP: Record<string, Partial<BrandingConfig>> = {
  ...
  'academia-demo.learnstream.app': {
    ...
    logoUrl: '/images/logo-learnstream.png', // Cambiar por el logo del cliente
  },
  'dprogramadores.com.co': {
    name: 'DProgramadores Academy',
    tagline: 'La vida en un código',
    logoUrl: '/images/logo-dprogramadores.png',
